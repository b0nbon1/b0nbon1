...
export default ({ children }) => {
  ...
  return (
    <div className='text-gray-800 bg-white dark:bg-gray-900 dark:text-white leading-normal flex flex-col min-h-full font-mono' ref={wholeWindow}>
      <div className='bg-gray-200 dark:bg-gray-800 border-b border-gray-300 dark:border-gray-700 py-4 shadow-sm z-50 fixed w-full'>
        <Link to="/">
           <div className='blog-logo'><Logo /></div> 
        </Link>
      </div>
      <aside
